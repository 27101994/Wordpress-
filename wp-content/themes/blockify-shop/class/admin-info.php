 ...
 */
class blockify_shop_Admin_Info {
    /**
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('Blockify Shop Theme', 'blockify-shop'),
            esc_html__('Blockify Shop Theme', 'blockify-shop'),
            'edit_theme_options',
            'blockify-shop',
    ...
    public function reset_notification_dismissal() {
        delete_transient('blockify_shop_notification_dismissed');
    }
    ...
    public function compatible_check() {
        ...
        $dismissed = get_transient('blockify_shop_notification_dismissed');
        if ($dismissed !== '1') {
    ...
    public function dismiss_notification() {
        ...
        set_transient('blockify_shop_notification_dismissed', '1', 7 * DAY_IN_SECONDS);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_blockify_shop_notification',
...
// Instantiate the Blockify Shop Admin Info class
new blockify_shop_Admin_Info();
