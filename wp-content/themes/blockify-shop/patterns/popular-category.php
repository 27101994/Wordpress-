...
<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--40);font-size:35px"><?php echo esc_html__( 'Popular Category', 'blockify-shop' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'Chic Timekeeping Companion', 'blockify-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Shop now', 'blockify-shop' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<h2 class="wp-block-heading has-text-align-center" style="font-size:35px"><?php echo esc_html__( 'Popular Category', 'blockify-shop' ); ?></h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-center has-white-constant-color has-text-color"><?php echo esc_html__( 'Classic Collection', 'blockify-shop' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"center"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button"><?php echo esc_html__( 'Shop now', 'blockify-shop' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<h3 class="wp-block-heading has-text-align-center has-white-constant-color has-text-color"><strong><?php echo esc_html__( 'Sporty Chronographs', 'blockify-shop' ); ?></strong></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-center has-white-constant-color has-text-color"><strong><?php echo esc_html__( 'Elegant Timepieces', 'blockify-shop' ); ?></strong></h3>
<!-- /wp:heading -->
