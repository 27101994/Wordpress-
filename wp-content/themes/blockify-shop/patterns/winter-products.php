...
<h3 class="wp-block-heading" style="font-size:35px"><?php echo esc_html__( 'Arctic Frost Series', 'blockify-shop' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<h4 class="wp-block-heading has-text-align-center has-normal-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Frostbrite Fusioni', 'blockify-shop' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( '$133', 'blockify-shop' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"center"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button"><?php echo esc_html__( 'Add to Cart', 'blockify-shop' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"normal"} -->
<h4 class="wp-block-heading has-text-align-center has-normal-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Alpine Majesty', 'blockify-shop' ); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"normal"} -->
<h4 class="wp-block-heading has-text-align-center has-normal-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Midnight Blizzard', 'blockify-shop' ); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"normal"} -->
<h4 class="wp-block-heading has-text-align-center has-normal-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Polar Horizon Precision', 'blockify-shop' ); ?></h4>
<!-- /wp:heading -->
